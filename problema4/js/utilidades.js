function Csueldo() {
    ...
    var utilidad = "";
    if (document.getElementById("year").value == "" || document.getElementById("sueldoM").value == "" ){
        utilidad = "No hay valroes en el campo años trabajdos" + "\n";
        utilidad += "No hay valores en el campo sueldo mensual" + "\n";
    }else{
